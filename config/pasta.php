...
$data = '[
  ...
  // con il json_decode stiamo generando un array associativo in php
  $data = json_decode($data,true);
  // il retur data permette a tutto l array di essere accessibile da qualsiasi parte
  // e se si vuole usare va richiamato
  return $data;
